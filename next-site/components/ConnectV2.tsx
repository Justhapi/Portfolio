 ...
 *
 * Email row: clicking the Email bullet opens a Gmail compose draft in a new
 * tab (pre-addressed to Kathleen). A companion "copy email" button next to
 * it copies the address to the clipboard for visitors who prefer their own
 * mail client. The inline expand-to-compose form was removed — the direct
 * open-Gmail-draft flow matches how LinkedIn / Resume behave (single click,
 * off you go) and skips the friction of typing into a form on the page.
 */

const EMAIL = "likathleen094@gmail.com";
// Gmail's compose URL — opens a new draft addressed to EMAIL in whichever
// Gmail account the visitor is signed into. Falls back gracefully to a
// standard Gmail landing page if they aren't signed in.
  ...
  const handleCopy = async () => {
    try {
      ...
      try {
        ...
        /* silent — user can still click the Gmail draft link */
      }
          ...
          <div className="connect-links">
            ...
            <div className="c-link c-email">
              <a
                ...
                aria-label="Open Gmail compose draft (new tab)"
              >
                <span>
                  <SparkleBullet />
                  Email
